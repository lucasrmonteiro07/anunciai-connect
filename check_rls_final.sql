-- Script para verificar se há algum problema com as políticas RLS
...
-- 10. Verificar se há dados na tabela public.services com user_id específico
SELECT 
...
-- 11. Verificar se há dados na tabela public.subscribers com user_id específico
SELECT 
