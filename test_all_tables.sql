-- Script para testar todas as tabelas como usuário logado
...
-- 7. Testar acesso à tabela services_public
SELECT 'Teste services_public' as teste, COUNT(*) as total_services_public FROM public.services_public;

-- 8. Ver alguns dados de exemplo da tabela services_public
SELECT 'Dados services_public' as teste, id, title, category, city, uf, status 
