-- Script para corrigir a função sync_services_to_public
...
-- 3. Adicionar colunas faltantes na tabela services_public
...
-- 4. Atualizar a função sync_services_to_public para incluir todas as colunas
...
-- 5. Verificar se a função foi atualizada
SELECT 'Função sync_services_to_public atualizada com sucesso' as resultado;
